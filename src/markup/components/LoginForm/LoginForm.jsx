    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        if (location.pathname === '/login') {
          // ✅ Updated redirect path for GitHub Pages
          window.location.replace('/Abe-Garage-Frontend/');
        } else {
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row clearfix">
                    ...
                    <div className="form-group col-md-12">
                      ...
                      <input type="email" name="employee_email" value={employee_email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" />
                      {emailError && <div className="validation-error" role="alert">{emailError}</div>}
                    </div>

                    <div className="form-group col-md-12">
                      <input type="password" name="employee_password" value={employee_password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
                      {passwordError && <div className="validation-error" role="alert">{passwordError}</div>}
                    </div>

                    <div className="form-group col-md-12">
                      <button className="theme-btn btn-style-one" type="submit"><span>Login</span></button>
                    </div>
                  </div>
                </form>
              </div>
