...
<div className="page-wrapper">
  ...
  <li className="list-item">
    <div className="icon">
      <span className="flaticon-pin"></span> {/* Larger, red icon */}
    </div>
    <div>
      <h5><strong>Address:</strong></h5>
      <p className="text">54B, Tailstoi Town 5238 MT, La city, IA 5224</p>
    </div>
  </li>

  <li className="list-item">
    <div className="icon">
      <span className="flaticon-email"></span> {/* Larger, red icon */}
    </div>
    <div>
      <h5><strong>Email:</strong></h5>
      <p className="text">contact@buildtruck.com</p>
    </div>
  </li>

  <li className="list-item">
    <div className="icon">
      <span className="flaticon-phone"></span> {/* Larger, red icon */}
    </div>
    <div>
      <h5><strong>Phone:</strong></h5>
      <p className="text">1800 456 7890 / 1254 897 3654</p>
    </div>
  </li>
</ul>
